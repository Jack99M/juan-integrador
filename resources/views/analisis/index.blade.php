...
<div class="card card-primary">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="analisisTable" class="table table-bordered table-striped table-hover">
                                ...
                                <div class="btn-group" role="group">
                                    ...
                                    @if($item->activo)
                                        <button type="button" class="btn btn-danger btn-sm" title="Desactivar" 
                                                onclick="confirmDeactivate({{ $item->id }}, '{{ $item->cod_analisis }}', 'analisis')">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cod_analisis" class="form-control" value="{{ $siguienteCodigo }}" readonly>
