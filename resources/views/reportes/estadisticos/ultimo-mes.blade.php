...
<head>
    <meta charset="utf-8">
    <title>Reporte Último Mes</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .period { text-align: center; background: #fff3cd; padding: 15px; border-radius: 8px; margin: 15px 0; }
        .stats { display: flex; justify-content: space-around; margin: 20px 0; }
        .stat-box { text-align: center; padding: 15px; background: #f8f9fa; border-radius: 8px; flex: 1; margin: 0 10px; }
        .stat-number { font-size: 32px; font-weight: bold; color: #ffc107; }
        .stat-label { font-size: 12px; color: #666; text-transform: uppercase; }
        .section-title { font-size: 18px; color: #ffc107; border-bottom: 2px solid #ffc107; padding-bottom: 8px; margin: 20px 0 15px; }
        table { width: 100%; border-collapse: collapse; margin: 15px 0; }
        th { background: #ffc107; color: white; padding: 10px; text-align: left; font-size: 12px; }
